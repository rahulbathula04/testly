    ...
    <section className="py-10 sm:py-14 bg-white border-b border-[#E5E7EB] font-[Inter,system-ui,sans-serif]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="text-center max-w-2xl mx-auto space-y-2 mb-7 sm:mb-10"
        >
          ...
          {VALUES.map((val, idx) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -3, backgroundColor: '#FFFFFF', borderColor: '#93C5FD', transition: { duration: 0.2, ease: 'easeOut' } }}
                whileTap={{ scale: 0.99 }}
                className="bg-[#FAF9F6] border border-[#E5E7EB] rounded-2xl p-4 sm:p-5 flex flex-col justify-between hover:shadow-md transition-colors group cursor-default select-none shadow-2xs"
              >
        ...
        <motion.div
          ...
          className="mt-8 pt-6 border-t border-[#E5E7EB] flex flex-col sm:flex-row items-center justify-between gap-3 text-center sm:text-left"
        >
